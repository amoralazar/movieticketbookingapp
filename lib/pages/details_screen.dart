...
class DetailsScreen extends StatelessWidget {
  ...
  // getting the movice model from arugments we passed
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // BUILDING OUR BODY USING THE WIDGET VARIABLES we create in the aboove
                ...
                child: Container(
                  decoration: const BoxDecoration(
                    image: DecorationImage(
                      fit: BoxFit.cover,
                      image: NetworkImage(
                        "https://images.pexels.com/photos/6303759/pexels-photo-6303759.jpeg?auto=compress&cs=tinysrgb&w=600",
                      ),
                    ),
                  ),
                ),
