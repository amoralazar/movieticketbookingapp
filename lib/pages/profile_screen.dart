...
class _ProfileScreenState extends State<ProfileScreen>
  ...
  Widget build(BuildContext context) {
    ...
    // setting our default mobile , text , email controller
      ...
      body: SizedBox(
        ...
        child: Stack(
          children: [
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    // person icon,  name fieled and edit icon
                    ...
                    // EMAIL icon,  name fieled and edit icon
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 20.0),
                      child: TextFormField(
                        initialValue: email,
                    ...
                    // end of EMAIL icon,  name fieled and edit icon
                    const SizedBox(height: 10),
                    const Padding(
                      padding: EdgeInsets.only(left: 70.0),
                      child: Text("Mobile"),
                    ...
                    // MOBILE icon,  name fieled and edit icon
                    Obx(
                      () => Padding(
                        padding: const EdgeInsets.symmetric(horizontal: 20.0),
                        child: TextFormField(
                    ...
                    Padding(
                      ...
                      child: ListTile(
                        ...
                        onTap: () {
                          // our app policy should be displayed
                        },
                      ),
                    ),
                    Padding(
                      ...
                      child: ListTile(
                        ...
                        onTap: () {
                          // try to write some code share with blal bla bla
                        },
                      ),
                    ),

                    // Log out button wheen it clicked we will log out from the system
            ...
            // end of 1st development .... now we will stack the 2nd body which is our prodile image
            //
            ...
            // camera image
            // we will create on tab on camera and we will change our profile image
            Positioned(
              top: 170,
